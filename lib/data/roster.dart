...
const List<ChampionDef> roster = [
  ...
  ChampionDef(
    name: 'Oorgath',
    role: ChampionRole.tank,
    element: GameElement.earth,
  ),
  ChampionDef(
    name: 'Voltgraven',
    role: ChampionRole.tank,
    element: GameElement.lightning,
  ),
  ChampionDef(
    name: 'Magmus',
    role: ChampionRole.tank,
  ...
  ChampionDef(
    name: 'Friedrich Blitzberg',
    role: ChampionRole.mage,
    element: GameElement.lightning,
  ),
  ChampionDef(
    name: 'Omnes',
    role: ChampionRole.healer,
    element: GameElement.wind,
  ),
  ChampionDef(
    name: 'The Cosmic Eye',
